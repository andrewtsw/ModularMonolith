...
{
    internal class SearchProductsQueryHandler : IRequestHandler<SearchProductsQuery, IReadOnlyList<ProductDto>>
    {
        private const int MaxSearchProducts = 100;

        private readonly IDbContext _context;
        private readonly IDateTime _dateTime;
        private readonly IMapper _mapper;

        public SearchProductsQueryHandler(IDbContext context, IDateTime dateTime, IMapper mapper)
        {
            _context = context;
            _dateTime = dateTime;
            _mapper = mapper;
