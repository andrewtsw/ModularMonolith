...
namespace TCO.SNT.DataAccess.SqlServer.Migrations
{
    ...
    [Migration("20201214050232_Change_EsfUserProfile_UserId_Type_To_Guid")]
    partial class Change_EsfUserProfile_UserId_Type_To_Guid
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TCO.SNT.Entities.Settings", b =>
                {
                    ...
                    b.Property<DateTime>("UFormUpdatesLastEventDate")
                        .HasColumnType("datetime2");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            GsvsLastChangeId = 0L,
                            UFormUpdatesLastEventDate = new DateTime(2019, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
            ...
            modelBuilder.Entity("TCO.SNT.Entities.UFormParticipant", b =>
                {
                    b.HasOne("TCO.SNT.Entities.TaxpayerStore", "Store")
                        .WithMany()
            ...
            modelBuilder.Entity("TCO.SNT.Entities.UFormProduct", b =>
                {
                    ...
                    b.HasOne("TCO.SNT.Entities.Balance", "Product")
                        .WithMany()
