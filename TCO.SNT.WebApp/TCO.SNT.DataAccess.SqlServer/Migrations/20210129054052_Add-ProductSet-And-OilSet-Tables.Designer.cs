...
namespace TCO.SNT.DataAccess.SqlServer.Migrations
{
    ...
    [Migration("20210129054052_Add-ProductSet-And-OilSet-Tables")]
    partial class AddProductSetAndOilSetTables
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TCO.SNT.Entities.SntExport", b =>
                {
                    b.Property<int>("SntId")
                        .HasColumnType("int");
                    ...
                    b.Property<long?>("ExternalSezCode")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("TCO.SNT.Entities.SntImport", b =>
                {
                    b.Property<int>("SntId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TCO.SNT.Entities.SntProduct", b =>
                {
                    ...
                    b.Property<string>("ExternalGtinCode")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("TCO.SNT.Entities.SntExport", b =>
                {
                    b.HasOne("TCO.SNT.Entities.Snt", "Snt")
                        .WithOne("SntExport")
                        .HasForeignKey("TCO.SNT.Entities.SntExport", "SntId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("TCO.SNT.Entities.SntImport", b =>
                {
                    b.HasOne("TCO.SNT.Entities.Snt", "Snt")
                        .WithOne("SntImport")
                        .HasForeignKey("TCO.SNT.Entities.SntImport", "SntId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
